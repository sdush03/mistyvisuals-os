          ...
          {showInstallButton && (
            <div className="mt-6 pt-4 border-t border-[var(--border)]">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg text-[13px] font-semibold text-neutral-800 dark:text-neutral-200 bg-[var(--surface-strong)] hover:bg-[var(--border-strong)] border border-[var(--border)] transition-all cursor-pointer shadow-sm hover:shadow"
              >

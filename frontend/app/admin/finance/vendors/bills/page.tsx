        ...
        <div className="space-y-8 max-w-6xl mx-auto pb-32">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/admin/finance/vendors" className="p-2 -ml-2 rounded-full hover:bg-neutral-100 transition text-neutral-500">
                            ...
                            {loading ? (
                                ...
                                bills.map(b => (
                                    <tr key={b.id} className="hover:bg-[var(--surface-muted)] transition">
                                        ...
                                        <td className="px-6 py-4 text-right font-medium">₹{formatAmount(b.bill_amount)}</td>
                                        <td className="px-6 py-4 text-center">
                                            <span className={`px-2.5 py-1 rounded text-xs font-semibold uppercase tracking-wider ${statusColors[b.status] || ''}`}>
                                                {b.status}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <Link href={`/admin/finance/vendors/bills/${b.id}`} className="text-brand-600 hover:text-brand-800 font-semibold uppercase tracking-wider text-xs">
                                                View
                                            </Link>
                                        </td>
                                    </tr>

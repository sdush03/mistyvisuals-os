                ...
                {transferSuccess ? (
                  ...
                  <>
                    <div className="rounded-2xl border border-white/[0.05] bg-white/[0.02] p-5 space-y-4 text-center">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-white/90">Upload Payment Proof</h4>
                        <p className="text-[11px] text-white/50 leading-relaxed mt-1">Please upload a screenshot of your bank transfer or UPI receipt as proof of payment.</p>
                      </div>
